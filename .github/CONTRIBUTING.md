...
```bash
# Clone the repo
git clone https://github.com/rushikesh-pande/subscriptions.git
cd subscriptions
...
Open a [Discussion](https://github.com/rushikesh-pande/subscriptions/discussions) or
